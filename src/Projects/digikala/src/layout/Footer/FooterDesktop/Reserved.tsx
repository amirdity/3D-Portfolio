function Reserved() {
  return (
    <div className="flex flex-col items-center justify-center  text-[21px] leading-8 my-5 border-t-[1px] py-10 text-gray-500 text-center mx-10">
      <p>
      ...
      <img src="" alt="" />
      <p>این سایت با هدف غیر تجاری و جهت اراعه نمونه کار ساخته شده.</p>
      <p>
        منبع :{" "}
        <a
